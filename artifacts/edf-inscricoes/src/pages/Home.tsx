...
import { Trophy, ArrowRight, ShieldCheck, Timer, Users } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Header */}
      <header className="w-full px-6 py-6 flex justify-between items-center z-10 relative max-w-7xl mx-auto">
        ...
        <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center lg:justify-end z-10">
            <div className="relative">
              ...
              <div className="relative bg-card p-8 sm:p-12 rounded-[2rem] shadow-2xl border border-white/20 backdrop-blur-xl flex flex-col items-center text-center">
                ...
                <div className="bg-white p-4 rounded-2xl shadow-inner border border-border/50">
                  {registerUrl ? (
                    <QRCodeSVG 
                      ...
                      fgColor="#0f172a" // foreground color
                    />
                  ) : (
